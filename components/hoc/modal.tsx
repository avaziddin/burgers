        ...
        <>
            ...
            {isOpend && (
                <div
                    ...
                    <div className="xs:w-[100%] sm:w-[80%] md:w-[80%] lg:w-[60%] xl:w-[70%] xs:p-[2%]  sm:p-[1%] relative xs:h-[100vh] sm:h-fit bg-white xs:rounded-none sm:rounded-[20px]">
                        <button className='absolute xs:right-[2%] xs:top-[1%] sm:right-[2%] sm:top-[3%]' onClick={() => setIsOpend(false)}>
                            <Image src="/images/isfaniguzin.svg" alt="close_btn" width={30} height={30} />
                        </button>
                        {children}
                    </div>
                </div>
